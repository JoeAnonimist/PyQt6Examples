...
from PyQt6.QtGui import QPainter, QColor, QPen, QBrush, QColor, QPixmap
import sys
import random
...
class Window(QWidget):
    ...
    def initUi(self, timer):
        ...
        self.label_cought.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.label_missed = QLabel('Raindrops missed: 0')
        self.label_missed.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        scene_brush = QBrush(Qt.GlobalColor.darkBlue)
